...
# Check if the requests were successful
if response_guten_report.status_code == 200 and response_giper_report.status_code == 200 and response_kitchen_report.status_code == 200:
    ...
    print(f"Failed to download task data:Guten, Giper and Kitchen Status code: {response_guten_report.status_code, response_giper_report.status_code,response_kitchen_report.status_code}")
    print(f"Response: {response_guten_report.text,response_giper_report.text,response_kitchen_report.text}")
